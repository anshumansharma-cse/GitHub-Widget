...
class GitDesktopWidget:
    def __init__(self):
        ...
        # <Escape> is Tkinter event code for Escape Key
        # 'lambda event':Creates anonymous function->accepts event object generated by tkinter 
        # 'self.root.destroy()': Safely closes window (Widget), breaks mainloop()-> kills underlying Script, interupt not needeed (error free)
